...
//void parsing(const char* before, char *ary[100], int* n);
...
load (const char *file_name, void (**eip) (void), void **esp) 
{
  ...
  int idx = 0;
  char copyary[100];
  strlcpy(copyary, file_name, strlen(file_name)+1);
  tok = strtok_r(copyary, " ", &next);
  while(tok)
  {
    array[idx++] = tok;
    //printf("test test = %s\n\n", aryy[idx-1]);
...
// void parsing(const char* before, char *aryy[100], int* n)
// {
//   char* tok;
//   char* next;
//   int idx = 0;
//   char copyary[50];
//   strlcpy(copyary, before, strlen(before)+1);
//   tok = strtok_r(copyary, " ", &next);
//   while(tok)
//   {
//     aryy[idx++] = tok;
